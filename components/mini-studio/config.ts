...
export const FURNITURE = [
  {
    id: 'desk', position: [-1.45, 0, -1.45], label: 'Laptop · Coding', activity: 'coding',
  ...
  {
    id: 'chair', position: [-1.55, 0, -0.4], label: 'Chair · Coding', activity: 'coding',
  ...
  {
    id: 'monitor', position: [-0.77, 1.55, -1.62], label: 'Monitor · Reviewing', activity: 'reviewing',
    interactionArea: [1, 0.8, 0.2], destination: [-0.2, -0.12], yaw: -2.8,
  },
  {
    id: 'beanbag', position: [1.65, 0, -1.05], label: 'Beanbag · Resting', activity: 'sleeping',
  ...
  {
    id: 'snacks', position: [2.6, 0, 1.03], label: 'Snacks · Eating', activity: 'eating',
...
export const ACTIVITIES: Record<Activity, ActivityConfig> = {
  coding: { label: 'Coding', status: 'Polishing the website…', duration: 18, weight: 5, furniture: 'chair' },
  reviewing: { label: 'Reviewing', status: 'Checking desktop, checking mobile. Looks good!', duration: 12, weight: 4, furniture: 'monitor' },
  eating: { label: 'Eating', status: 'Refueling energy.', duration: 9, weight: 1, furniture: 'snacks' },
  sleeping: { label: 'Resting', status: 'Taking a short break.', duration: 13, weight: 1, furniture: 'beanbag' },
  waving: { label: 'Greeting', status: 'Hello! What do you want to build with us?', duration: 6, weight: 1 },
}
